...
const MODULES = [
  ...
  { slug: "qualidade_bpa", name: "Qualidade BPA", description: "Analisa um arquivo BPA já gerado (BPA-C/BPA-I) — painéis, filtros e verificações de qualidade por procedimento SIGTAP — e no mesmo lugar revisa e corrige as pendências encontradas, com renumeração automática de folha/sequência e geração do arquivo corrigido.", status: "live", sort_order: 4 },
  { slug: "datasus_sia", name: "DATASUS · SIA/SUS", description: "Analisa o relatório RSPROCED (produzido × aprovado por procedimento SIGTAP e unidade) após o processamento do BPA/FPO pelo SIA/SUS, identificando glosas por procedimento e por unidade.", status: "live", sort_order: 5 },
  { slug: "acompanhamento_pec", name: "Acompanhamento Cidadãos PEC", description: "Cruza os relatórios de cidadãos vinculados, condições de saúde e território do e-SUS PEC para identificar cadastros sem endereço, desatualizados, sem atendimento registrado ou sem domicílio mapeado.", status: "live", sort_order: 6 },
  { slug: "mapa_territorio", name: "Mapa do Território", description: "Organiza o relatório de Acompanhamento do Território do e-SUS PEC por bairro e logradouro, com contagem de pessoas e famílias, unificação de ruas com nome divergente e impressão do relatório consolidado.", status: "live", sort_order: 7 },
