(function (root) {
  ...
  const PROBLEMA_CATALOG = {
    ...
    CBO_NAO_PERMITIDO: { sev: "erro", texto: "Procedimento não permitido para o CBO",
      ...
      resolver: "Informe o CBO correto do profissional que executou o procedimento (campo Correção abaixo), ou confira se o código SIGTAP lançado é mesmo o que esse profissional realizou." },
